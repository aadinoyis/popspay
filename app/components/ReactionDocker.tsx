  ...
  return (
    ...
    <div className="docker_box">
      ...
      <div style={{
        ...
        <span><strong>You&apos;ve sent <span style={{color: 'var(--color-main)'}}>NGN 2,000</span> to @aadinoyis</strong></span>
      </div>
    </div>
  </div>
  )
  ...
  return (
    ...
    <div className="docker_box">
      ...
      <div style={{
        ...
        <span><strong>You&apos;ve received <span style={{color: 'var(--color-main)'}}>NGN 2,000</span> from @aadinoyis_two</strong></span>
      </div>
    </div>
  </div>
  )
